...
import {
  ...
  Heart, Settings, Users, Gift, X, Check, Plus, Trash2, User, Lock
} from 'lucide-react';
...
const GiftFinder = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-sans pb-24 text-slate-900">
            ...
            {!isLoggedIn ? (
              ...
              >
                <div className="text-center mb-10">
                  <div className="w-20 h-20 bg-[#7C3AED] rounded-3xl flex items-center justify-center text-white mx-auto mb-6 shadow-xl shadow-purple-100">
                    <Gift size={40} />
                  </div>
                  <h1 className="text-3xl font-black text-slate-900 leading-tight">Welcome</h1>
                  <p className="text-gray-400 font-medium">Log in to your Gift Circle</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <button type="submit" className="w-full bg-slate-900 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg hover:bg-slate-800 transition-all mt-6">
                  ...
                  <motion.div key="settings" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex-1">
                    ...
                    <div className="space-y-4">
                      ...
                      <button 
                        ...
                        className="w-full p-4 text-red-500 font-bold bg-red-50 rounded-2xl hover:bg-red-100 transition-colors"
                      >
                        Log Out
                      </button>
                    </div>
      ...
      {/* Nav Bar - Only visible if logged in */}
      {isLoggedIn && (
